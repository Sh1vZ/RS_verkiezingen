                ...
                <div class="col-lg-5 col-md-7">
                            ...
                            <form role="form" id="login-form">
                                ...
                                <div class="form-group">
                                    <div class="input-group input-group-merge input-group-alternative">
                                        ...
                                        <input class="form-control" placeholder="Password" id="pwd" type="password">
                                    </div>
                                </div>
                                <div class="text-center submit">
                                    <button type="button" onclick="Inloggen()" class=" btn btn-primary my-4 ">Inloggen</button>
                                </div>
                            </form>
                        </div>
                    </div>
                    <div class="row mt-3 ">
                        ...
                        <div class="col-6 text-right ">
                            <a href="./pages/register.php " class="text-white font-weight-bold "><small>Create new account</small></a>
                        </div>
                    </div>
                </div>
            </div>
